...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3ee:	6a 54                	push   $0x54
     3f0:	e8 4a 0f 00 00       	call   133f <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     424:	6a 18                	push   $0x18
     426:	e8 14 0f 00 00       	call   133f <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     487:	6a 0c                	push   $0xc
     489:	e8 b1 0e 00 00       	call   133f <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4cf:	6a 0c                	push   $0xc
     4d1:	e8 69 0e 00 00       	call   133f <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     517:	6a 08                	push   $0x8
     519:	e8 21 0e 00 00       	call   133f <malloc>
     ...
     55d:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     575:	50                   	push   %eax
     576:	68 a0 19 00 00       	push   $0x19a0
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     61e:	50                   	push   %eax
     61f:	68 a0 19 00 00       	push   $0x19a0
     ...
     63c:	50                   	push   %eax
     63d:	68 a8 19 00 00       	push   $0x19a8
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     67f:	50                   	push   %eax
     680:	68 a0 19 00 00       	push   $0x19a0
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6c6:	50                   	push   %eax
     6c7:	68 a0 19 00 00       	push   $0x19a0
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     74a:	68 8a 14 00 00       	push   $0x148a
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     76c:	50                   	push   %eax
     76d:	68 8b 14 00 00       	push   $0x148b
     772:	6a 02                	push   $0x2
     774:	e8 f3 08 00 00       	call   106c <printf>
     779:	83 c4 10             	add    $0x10,%esp
    panic("syntax");
     77c:	83 ec 0c             	sub    $0xc,%esp
     77f:	68 9a 14 00 00       	push   $0x149a
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     7e4:	68 a1 14 00 00       	push   $0x14a1
  ...
  if(peek(ps, es, ";")){
     ...
     7fe:	68 a3 14 00 00       	push   $0x14a3
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     ...
     86c:	68 a5 14 00 00       	push   $0x14a5
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     8fb:	68 a7 14 00 00       	push   $0x14a7
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     981:	68 c4 14 00 00       	push   $0x14c4
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     ...
     9aa:	68 c7 14 00 00       	push   $0x14c7
    ...
    panic("parseblock");
     ...
     9c4:	68 c9 14 00 00       	push   $0x14c9
  ...
  if(!peek(ps, es, ")"))
     ...
     9fa:	68 d4 14 00 00       	push   $0x14d4
    ...
    panic("syntax - missing )");
     ...
     a14:	68 d6 14 00 00       	push   $0x14d6
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     a58:	68 c7 14 00 00       	push   $0x14c7
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     ae2:	68 9a 14 00 00       	push   $0x149a
    ...
    if(argc >= MAXARGS)
     ...
     b19:	68 e9 14 00 00       	push   $0x14e9
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     b40:	68 f7 14 00 00       	push   $0x14f7
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ba6:	8b 04 85 fc 14 00 00 	mov    0x14fc(,%eax,4),%eax
     bad:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
00000f85 <down>:
SYSCALL(down)
     f85:	b8 17 00 00 00       	mov    $0x17,%eax
     f8a:	cd 40                	int    $0x40
     f8c:	c3                   	ret    
...
putc(int fd, char c)
{
     ...
     f98:	83 ec 18             	sub    $0x18,%esp
     f9b:	8b 45 0c             	mov    0xc(%ebp),%eax
     f9e:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
     fa1:	83 ec 04             	sub    $0x4,%esp
     fa4:	6a 01                	push   $0x1
     fa6:	8d 45 f4             	lea    -0xc(%ebp),%eax
     fa9:	50                   	push   %eax
     faa:	ff 75 08             	pushl  0x8(%ebp)
     fad:	e8 43 ff ff ff       	call   ef5 <write>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
     fbf:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
     fc6:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
     fca:	74 17                	je     fe3 <printint+0x2b>
     fcc:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
     fd0:	79 11                	jns    fe3 <printint+0x2b>
    neg = 1;
     fd2:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
     fd9:	8b 45 0c             	mov    0xc(%ebp),%eax
     fdc:	f7 d8                	neg    %eax
     fde:	89 45 ec             	mov    %eax,-0x14(%ebp)
     fe1:	eb 06                	jmp    fe9 <printint+0x31>
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
     ff0:	8b 4d f4             	mov    -0xc(%ebp),%ecx
     ff3:	8d 41 01             	lea    0x1(%ecx),%eax
     ff6:	89 45 f4             	mov    %eax,-0xc(%ebp)
     ff9:	8b 5d 10             	mov    0x10(%ebp),%ebx
     ffc:	8b 45 ec             	mov    -0x14(%ebp),%eax
     fff:	ba 00 00 00 00       	mov    $0x0,%edx
    1004:	f7 f3                	div    %ebx
    1006:	89 d0                	mov    %edx,%eax
    1008:	0f b6 80 b0 19 00 00 	movzbl 0x19b0(%eax),%eax
    100f:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    1013:	8b 5d 10             	mov    0x10(%ebp),%ebx
    1016:	8b 45 ec             	mov    -0x14(%ebp),%eax
    1019:	ba 00 00 00 00       	mov    $0x0,%edx
    101e:	f7 f3                	div    %ebx
    1020:	89 45 ec             	mov    %eax,-0x14(%ebp)
    1023:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    1027:	75 c7                	jne    ff0 <printint+0x38>
  if(neg)
    1029:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    102d:	74 2d                	je     105c <printint+0xa4>
    buf[i++] = '-';
    102f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1032:	8d 50 01             	lea    0x1(%eax),%edx
    1035:	89 55 f4             	mov    %edx,-0xc(%ebp)
    1038:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    103d:	eb 1d                	jmp    105c <printint+0xa4>
    putc(fd, buf[i]);
    103f:	8d 55 dc             	lea    -0x24(%ebp),%edx
    1042:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1045:	01 d0                	add    %edx,%eax
    1047:	0f b6 00             	movzbl (%eax),%eax
    104a:	0f be c0             	movsbl %al,%eax
    104d:	83 ec 08             	sub    $0x8,%esp
    1050:	50                   	push   %eax
    1051:	ff 75 08             	pushl  0x8(%ebp)
    1054:	e8 3c ff ff ff       	call   f95 <putc>
  ...
  while(--i >= 0)
    105c:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    1060:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    1064:	79 d9                	jns    103f <printint+0x87>
    putc(fd, buf[i]);
}
    1066:	90                   	nop
    1067:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    106a:	c9                   	leave  
    106b:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    10c9:	e8 c7 fe ff ff       	call   f95 <putc>
    ...
    10f3:	e8 c0 fe ff ff       	call   fb8 <printint>
    ...
    111d:	e8 96 fe ff ff       	call   fb8 <printint>
    ...
    115f:	e8 31 fe ff ff       	call   f95 <putc>
    ...
    118c:	e8 04 fe ff ff       	call   f95 <putc>
    ...
    11ad:	e8 e3 fd ff ff       	call   f95 <putc>
    ...
    11bf:	e8 d1 fd ff ff       	call   f95 <putc>
    ...
    11d4:	e8 bc fd ff ff       	call   f95 <putc>
...
free(void *ap)
{
  ...
  freep = p;
    ...
    12d7:	a3 4c 1a 00 00       	mov    %eax,0x1a4c
}
    12dc:	90                   	nop
    12dd:	c9                   	leave  
    12de:	c3                   	ret    
...
morecore(uint nu)
{
    ...
    12e2:	83 ec 18             	sub    $0x18,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    12e5:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    12ec:	77 07                	ja     12f5 <morecore+0x16>
    nu = 4096;
    12ee:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    12f5:	8b 45 08             	mov    0x8(%ebp),%eax
    12f8:	c1 e0 03             	shl    $0x3,%eax
    12fb:	83 ec 0c             	sub    $0xc,%esp
    12fe:	50                   	push   %eax
    12ff:	e8 59 fc ff ff       	call   f5d <sbrk>
    1304:	83 c4 10             	add    $0x10,%esp
    1307:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    130a:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    130e:	75 07                	jne    1317 <morecore+0x38>
    return 0;
    1310:	b8 00 00 00 00       	mov    $0x0,%eax
    1315:	eb 26                	jmp    133d <morecore+0x5e>
  hp = (Header*)p;
    1317:	8b 45 f4             	mov    -0xc(%ebp),%eax
    131a:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    131d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1320:	8b 55 08             	mov    0x8(%ebp),%edx
    1323:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    1326:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1329:	83 c0 08             	add    $0x8,%eax
    132c:	83 ec 0c             	sub    $0xc,%esp
    132f:	50                   	push   %eax
    1330:	e8 c8 fe ff ff       	call   11fd <free>
    1335:	83 c4 10             	add    $0x10,%esp
  return freep;
    1338:	a1 4c 1a 00 00       	mov    0x1a4c,%eax
}
    133d:	c9                   	leave  
    133e:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    1348:	83 c0 07             	add    $0x7,%eax
    134b:	c1 e8 03             	shr    $0x3,%eax
    134e:	83 c0 01             	add    $0x1,%eax
    1351:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    1354:	a1 4c 1a 00 00       	mov    0x1a4c,%eax
    1359:	89 45 f0             	mov    %eax,-0x10(%ebp)
    135c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1360:	75 23                	jne    1385 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    1362:	c7 45 f0 44 1a 00 00 	movl   $0x1a44,-0x10(%ebp)
    1369:	8b 45 f0             	mov    -0x10(%ebp),%eax
    136c:	a3 4c 1a 00 00       	mov    %eax,0x1a4c
    1371:	a1 4c 1a 00 00       	mov    0x1a4c,%eax
    1376:	a3 44 1a 00 00       	mov    %eax,0x1a44
    base.s.size = 0;
    137b:	c7 05 48 1a 00 00 00 	movl   $0x0,0x1a48
    1382:	00 00 00 
  }
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    141b:	e9 6d ff ff ff       	jmp    138d <malloc+0x4e>
}
    1420:	c9                   	leave  
    1421:	c3                   	ret    
