...
_usertests:     формат файла elf32-i386
...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
      ...
      13:	50                   	push   %eax
      14:	e8 4d 40 00 00       	call   4066 <printf>
  ...
  if(mkdir("iputdir") < 0){
    ...
    printf(stdout, "mkdir failed\n");
      ...
      3d:	50                   	push   %eax
      3e:	e8 23 40 00 00       	call   4066 <printf>
  ...
  if(chdir("iputdir") < 0){
    ...
    printf(stdout, "chdir iputdir failed\n");
      ...
      6c:	50                   	push   %eax
      6d:	e8 f4 3f 00 00       	call   4066 <printf>
  ...
  if(unlink("../iputdir") < 0){
    ...
    printf(stdout, "unlink ../iputdir failed\n");
      ...
      9b:	50                   	push   %eax
      9c:	e8 c5 3f 00 00       	call   4066 <printf>
  ...
  if(chdir("/") < 0){
    ...
    printf(stdout, "chdir / failed\n");
      ...
      ca:	50                   	push   %eax
      cb:	e8 96 3f 00 00       	call   4066 <printf>
  ...
  printf(stdout, "iput test ok\n");
      ...
      e5:	50                   	push   %eax
      e6:	e8 7b 3f 00 00       	call   4066 <printf>
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     104:	50                   	push   %eax
     105:	e8 5c 3f 00 00       	call   4066 <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     ...
     128:	50                   	push   %eax
     129:	e8 38 3f 00 00       	call   4066 <printf>
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     161:	50                   	push   %eax
     162:	e8 ff 3e 00 00       	call   4066 <printf>
    ...
    if(chdir("iputdir") < 0){
     ...
     190:	50                   	push   %eax
     191:	e8 d0 3e 00 00       	call   4066 <printf>
    ...
    if(unlink("../iputdir") < 0){
     ...
     1bf:	50                   	push   %eax
     1c0:	e8 a1 3e 00 00       	call   4066 <printf>
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     1e4:	50                   	push   %eax
     1e5:	e8 7c 3e 00 00       	call   4066 <printf>
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     ...
     203:	50                   	push   %eax
     204:	e8 5d 3e 00 00       	call   4066 <printf>
  ...
  if(mkdir("oidir") < 0){
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     22d:	50                   	push   %eax
     22e:	e8 33 3e 00 00       	call   4066 <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     ...
     256:	50                   	push   %eax
     257:	e8 0a 3e 00 00       	call   4066 <printf>
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     292:	50                   	push   %eax
     293:	e8 ce 3d 00 00       	call   4066 <printf>
  ...
  if(unlink("oidir") != 0){
    ...
    printf(stdout, "unlink failed\n");
     ...
     2d3:	50                   	push   %eax
     2d4:	e8 8d 3d 00 00       	call   4066 <printf>
  ...
  printf(stdout, "openiput test ok\n");
     ...
     2f3:	50                   	push   %eax
     2f4:	e8 6d 3d 00 00       	call   4066 <printf>
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     ...
     312:	50                   	push   %eax
     313:	e8 4e 3d 00 00       	call   4066 <printf>
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     ...
     343:	50                   	push   %eax
     344:	e8 1d 3d 00 00       	call   4066 <printf>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     387:	50                   	push   %eax
     388:	e8 d9 3c 00 00       	call   4066 <printf>
  ...
  printf(stdout, "open test ok\n");
     ...
     3a2:	50                   	push   %eax
     3a3:	e8 be 3c 00 00       	call   4066 <printf>
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     ...
     3c1:	50                   	push   %eax
     3c2:	e8 9f 3c 00 00       	call   4066 <printf>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     3f5:	50                   	push   %eax
     3f6:	e8 6b 3c 00 00       	call   4066 <printf>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     417:	50                   	push   %eax
     418:	e8 49 3c 00 00       	call   4066 <printf>
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     44f:	50                   	push   %eax
     450:	e8 11 3c 00 00       	call   4066 <printf>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     487:	50                   	push   %eax
     488:	e8 d9 3b 00 00       	call   4066 <printf>
  ...
  printf(stdout, "writes ok\n");
     ...
     4ac:	50                   	push   %eax
     4ad:	e8 b4 3b 00 00       	call   4066 <printf>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     4eb:	50                   	push   %eax
     4ec:	e8 75 3b 00 00       	call   4066 <printf>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     527:	50                   	push   %eax
     528:	e8 39 3b 00 00       	call   4066 <printf>
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     ...
     542:	50                   	push   %eax
     543:	e8 1e 3b 00 00       	call   4066 <printf>
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     ...
     57c:	50                   	push   %eax
     57d:	e8 e4 3a 00 00       	call   4066 <printf>
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     ...
     597:	50                   	push   %eax
     598:	e8 c9 3a 00 00       	call   4066 <printf>
  ...
  printf(stdout, "small file test ok\n");
     ...
     5b2:	50                   	push   %eax
     5b3:	e8 ae 3a 00 00       	call   4066 <printf>
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     5d1:	50                   	push   %eax
     5d2:	e8 8f 3a 00 00       	call   4066 <printf>
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     605:	50                   	push   %eax
     606:	e8 5b 3a 00 00       	call   4066 <printf>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     655:	50                   	push   %eax
     656:	e8 0b 3a 00 00       	call   4066 <printf>
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     6a7:	50                   	push   %eax
     6a8:	e8 b9 39 00 00       	call   4066 <printf>
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     6f6:	50                   	push   %eax
     6f7:	e8 6a 39 00 00       	call   4066 <printf>
     ...
     71d:	50                   	push   %eax
     71e:	e8 43 39 00 00       	call   4066 <printf>
    ...
    if(((int*)buf)[0] != n){
     ...
     74c:	50                   	push   %eax
     74d:	e8 14 39 00 00       	call   4066 <printf>
  ...
  if(unlink("big") < 0){
    ...
    printf(stdout, "unlink big failed\n");
     ...
     793:	50                   	push   %eax
     794:	e8 cd 38 00 00       	call   4066 <printf>
  ...
  printf(stdout, "big files ok\n");
     ...
     7ae:	50                   	push   %eax
     7af:	e8 b2 38 00 00       	call   4066 <printf>
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     7cd:	50                   	push   %eax
     7ce:	e8 93 38 00 00       	call   4066 <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     871:	50                   	push   %eax
     872:	e8 ef 37 00 00       	call   4066 <printf>
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     890:	50                   	push   %eax
     891:	e8 d0 37 00 00       	call   4066 <printf>
  ...
  if(mkdir("dir0") < 0){
    ...
    printf(stdout, "mkdir failed\n");
     ...
     8ba:	50                   	push   %eax
     8bb:	e8 a6 37 00 00       	call   4066 <printf>
  ...
  if(chdir("dir0") < 0){
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     8e9:	50                   	push   %eax
     8ea:	e8 77 37 00 00       	call   4066 <printf>
  ...
  if(chdir("..") < 0){
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     918:	50                   	push   %eax
     919:	e8 48 37 00 00       	call   4066 <printf>
  ...
  if(unlink("dir0") < 0){
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     947:	50                   	push   %eax
     948:	e8 19 37 00 00       	call   4066 <printf>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     962:	50                   	push   %eax
     963:	e8 fe 36 00 00       	call   4066 <printf>
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     ...
     981:	50                   	push   %eax
     982:	e8 df 36 00 00       	call   4066 <printf>
  ...
  if(exec("echo", echoargv) < 0){
    ...
    printf(stdout, "exec echo failed\n");
     ...
     9b0:	50                   	push   %eax
     9b1:	e8 b0 36 00 00       	call   4066 <printf>
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     ...
     9e2:	6a 01                	push   $0x1
     9e4:	e8 7d 36 00 00       	call   4066 <printf>
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     a75:	6a 01                	push   $0x1
     a77:	e8 ea 35 00 00       	call   4066 <printf>
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     aed:	6a 01                	push   $0x1
     aef:	e8 72 35 00 00       	call   4066 <printf>
    ...
    if(total != 5 * 1033){
     ...
     b5a:	6a 01                	push   $0x1
     b5c:	e8 05 35 00 00       	call   4066 <printf>
  ...
  printf(1, "pipe1 ok\n");
     ...
     b85:	6a 01                	push   $0x1
     b87:	e8 da 34 00 00       	call   4066 <printf>
    ...
    printf(1, "fork() failed\n");
     ...
     b99:	6a 01                	push   $0x1
     b9b:	e8 c6 34 00 00       	call   4066 <printf>
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     ...
     bb8:	6a 01                	push   $0x1
     bba:	e8 a7 34 00 00       	call   4066 <printf>
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     c31:	6a 01                	push   $0x1
     c33:	e8 2e 34 00 00       	call   4066 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     ...
     c81:	6a 01                	push   $0x1
     c83:	e8 de 33 00 00       	call   4066 <printf>
  ...
  printf(1, "kill... ");
     ...
     ca4:	6a 01                	push   $0x1
     ca6:	e8 bb 33 00 00       	call   4066 <printf>
  ...
  printf(1, "wait... ");
     ...
     ce0:	6a 01                	push   $0x1
     ce2:	e8 7f 33 00 00       	call   4066 <printf>
  ...
  printf(1, "preempt ok\n");
     ...
     d01:	6a 01                	push   $0x1
     d03:	e8 5e 33 00 00       	call   4066 <printf>
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     d32:	6a 01                	push   $0x1
     d34:	e8 2d 33 00 00       	call   4066 <printf>
    ...
    if(pid){
     ...
     d56:	6a 01                	push   $0x1
     d58:	e8 09 33 00 00       	call   4066 <printf>
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     ...
     d79:	6a 01                	push   $0x1
     d7b:	e8 e6 32 00 00       	call   4066 <printf>
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     ...
     d93:	6a 01                	push   $0x1
     d95:	e8 cc 32 00 00       	call   4066 <printf>
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     dd6:	e8 5e 35 00 00       	call   4339 <malloc>
    ...
    while(m1){
     ...
     df7:	e8 fb 33 00 00       	call   41f7 <free>
    ...
    m1 = malloc(1024*20);
     ...
     e13:	e8 21 35 00 00       	call   4339 <malloc>
    ...
    if(m1 == 0){
     ...
     e2c:	6a 01                	push   $0x1
     e2e:	e8 33 32 00 00       	call   4066 <printf>
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     ...
     e84:	6a 01                	push   $0x1
     e86:	e8 db 31 00 00       	call   4066 <printf>
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     ec4:	6a 01                	push   $0x1
     ec6:	e8 9b 31 00 00       	call   4066 <printf>
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     f29:	6a 01                	push   $0x1
     f2b:	e8 36 31 00 00       	call   4066 <printf>
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     f83:	6a 01                	push   $0x1
     f85:	e8 dc 30 00 00       	call   4066 <printf>
  ...
  if(nc == 10000 && np == 10000){
    ...
    1031:	6a 01                	push   $0x1
    1033:	e8 2e 30 00 00       	call   4066 <printf>
    ...
    1048:	6a 01                	push   $0x1
    104a:	e8 17 30 00 00       	call   4066 <printf>
...
fourfiles(void)
{
  ...
  printf(1, "fourfiles test\n");
    ...
    1083:	6a 01                	push   $0x1
    1085:	e8 dc 2f 00 00       	call   4066 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    10c7:	6a 01                	push   $0x1
    10c9:	e8 98 2f 00 00       	call   4066 <printf>
    ...
    1104:	6a 01                	push   $0x1
    1106:	e8 5b 2f 00 00       	call   4066 <printf>
    ...
    1167:	6a 01                	push   $0x1
    1169:	e8 f8 2e 00 00       	call   4066 <printf>
  ...
  for(i = 0; i < 2; i++){
    ...
    1206:	6a 01                	push   $0x1
    1208:	e8 59 2e 00 00       	call   4066 <printf>
  ...
  for(i = 0; i < 2; i++){
    ...
    126a:	6a 01                	push   $0x1
    126c:	e8 f5 2d 00 00       	call   4066 <printf>
  ...
  printf(1, "fourfiles ok\n");
    ...
    129d:	6a 01                	push   $0x1
    129f:	e8 c2 2d 00 00       	call   4066 <printf>
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    ...
    12b3:	68 9c 4a 00 00       	push   $0x4a9c
    12b8:	6a 01                	push   $0x1
    12ba:	e8 a7 2d 00 00       	call   4066 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    12df:	68 bd 44 00 00       	push   $0x44bd
    12e4:	6a 01                	push   $0x1
    12e6:	e8 7b 2d 00 00       	call   4066 <printf>
    ...
    133f:	68 51 4a 00 00       	push   $0x4a51
    1344:	6a 01                	push   $0x1
    1346:	e8 1b 2d 00 00       	call   4066 <printf>
    ...
    1399:	68 40 45 00 00       	push   $0x4540
    139e:	6a 01                	push   $0x1
    13a0:	e8 c1 2c 00 00       	call   4066 <printf>
  ...
  for(i = 0; i < N; i++){
    ...
    144e:	50                   	push   %eax
    144f:	68 b0 4a 00 00       	push   $0x4ab0
    1454:	6a 01                	push   $0x1
    1456:	e8 0b 2c 00 00       	call   4066 <printf>
    ...
    147b:	50                   	push   %eax
    147c:	68 d4 4a 00 00       	push   $0x4ad4
    1481:	6a 01                	push   $0x1
    1483:	e8 de 2b 00 00       	call   4066 <printf>
  ...
  printf(1, "createdelete ok\n");
    ...
    150a:	68 f4 4a 00 00       	push   $0x4af4
    150f:	6a 01                	push   $0x1
    1511:	e8 50 2b 00 00       	call   4066 <printf>
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1525:	68 05 4b 00 00       	push   $0x4b05
    152a:	6a 01                	push   $0x1
    152c:	e8 35 2b 00 00       	call   4066 <printf>
    1531:	83 c4 10             	add    $0x10,%esp
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1534:	83 ec 08             	sub    $0x8,%esp
    1537:	68 02 02 00 00       	push   $0x202
    153c:	68 16 4b 00 00       	push   $0x4b16
  ...
  if(fd < 0){
    ...
    1555:	68 21 4b 00 00       	push   $0x4b21
    155a:	6a 01                	push   $0x1
    155c:	e8 05 2b 00 00       	call   4066 <printf>
  ...
  write(fd, "hello", 5);
    ...
    156c:	6a 05                	push   $0x5
    156e:	68 3b 4b 00 00       	push   $0x4b3b
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    158f:	6a 02                	push   $0x2
    1591:	68 16 4b 00 00       	push   $0x4b16
  ...
  if(fd < 0){
    ...
    15aa:	68 41 4b 00 00       	push   $0x4b41
    15af:	6a 01                	push   $0x1
    15b1:	e8 b0 2a 00 00       	call   4066 <printf>
  ...
  if(unlink("unlinkread") != 0){
    ...
    15c1:	68 16 4b 00 00       	push   $0x4b16
    ...
    15d5:	68 59 4b 00 00       	push   $0x4b59
    15da:	6a 01                	push   $0x1
    15dc:	e8 85 2a 00 00       	call   4066 <printf>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    15f1:	68 16 4b 00 00       	push   $0x4b16
  ...
  write(fd1, "yyy", 3);
    ...
    1604:	6a 03                	push   $0x3
    1606:	68 73 4b 00 00       	push   $0x4b73
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1644:	68 77 4b 00 00       	push   $0x4b77
    1649:	6a 01                	push   $0x1
    164b:	e8 16 2a 00 00       	call   4066 <printf>
  ...
  if(buf[0] != 'h'){
    ...
    1666:	68 8e 4b 00 00       	push   $0x4b8e
    166b:	6a 01                	push   $0x1
    166d:	e8 f4 29 00 00       	call   4066 <printf>
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1697:	68 a5 4b 00 00       	push   $0x4ba5
    169c:	6a 01                	push   $0x1
    169e:	e8 c3 29 00 00       	call   4066 <printf>
  ...
  unlink("unlinkread");
    ...
    16bc:	68 16 4b 00 00       	push   $0x4b16
    16c1:	e8 59 28 00 00       	call   3f1f <unlink>
    16c6:	83 c4 10             	add    $0x10,%esp
  printf(1, "unlinkread ok\n");
    16c9:	83 ec 08             	sub    $0x8,%esp
    16cc:	68 be 4b 00 00       	push   $0x4bbe
    16d1:	6a 01                	push   $0x1
    16d3:	e8 8e 29 00 00       	call   4066 <printf>
...
linktest(void)
{
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
    ...
    171e:	68 d7 4b 00 00       	push   $0x4bd7
  ...
  if(fd < 0){
    ...
    1737:	68 df 4b 00 00       	push   $0x4bdf
    173c:	6a 01                	push   $0x1
    173e:	e8 23 29 00 00       	call   4066 <printf>
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    174e:	6a 05                	push   $0x5
    1750:	68 3b 4b 00 00       	push   $0x4b3b
    ...
    1768:	68 f2 4b 00 00       	push   $0x4bf2
    176d:	6a 01                	push   $0x1
    176f:	e8 f2 28 00 00       	call   4066 <printf>
  ...
  if(link("lf1", "lf2") < 0){
    ...
    178d:	68 db 4b 00 00       	push   $0x4bdb
    1792:	68 d7 4b 00 00       	push   $0x4bd7
    ...
    17ab:	6a 01                	push   $0x1
    17ad:	e8 b4 28 00 00       	call   4066 <printf>
  ...
  unlink("lf1");
    ...
    17bd:	68 d7 4b 00 00       	push   $0x4bd7
  ...
  if(open("lf1", 0) >= 0){
    ...
    17cd:	6a 00                	push   $0x0
    17cf:	68 d7 4b 00 00       	push   $0x4bd7
    ...
    17e8:	6a 01                	push   $0x1
    17ea:	e8 77 28 00 00       	call   4066 <printf>
  ...
  fd = open("lf2", 0);
    ...
    17fa:	6a 00                	push   $0x0
    17fc:	68 db 4b 00 00       	push   $0x4bdb
  ...
  if(fd < 0){
    ...
    181a:	6a 01                	push   $0x1
    181c:	e8 45 28 00 00       	call   4066 <printf>
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    184e:	6a 01                	push   $0x1
    1850:	e8 11 28 00 00       	call   4066 <printf>
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    186e:	68 db 4b 00 00       	push   $0x4bdb
    1873:	68 db 4b 00 00       	push   $0x4bdb
    ...
    1887:	68 63 4c 00 00       	push   $0x4c63
    188c:	6a 01                	push   $0x1
    188e:	e8 d3 27 00 00       	call   4066 <printf>
  ...
  unlink("lf2");
    ...
    189e:	68 db 4b 00 00       	push   $0x4bdb
    18a3:	e8 77 26 00 00       	call   3f1f <unlink>
    18a8:	83 c4 10             	add    $0x10,%esp
  if(link("lf2", "lf1") >= 0){
    18ab:	83 ec 08             	sub    $0x8,%esp
    18ae:	68 d7 4b 00 00       	push   $0x4bd7
    18b3:	68 db 4b 00 00       	push   $0x4bdb
    ...
    18cc:	6a 01                	push   $0x1
    18ce:	e8 93 27 00 00       	call   4066 <printf>
  ...
  if(link(".", "lf1") >= 0){
    ...
    18de:	68 d7 4b 00 00       	push   $0x4bd7
    ...
    18fc:	6a 01                	push   $0x1
    18fe:	e8 63 27 00 00       	call   4066 <printf>
  ...
  printf(1, "linktest ok\n");
    ...
    1913:	6a 01                	push   $0x1
    1915:	e8 4c 27 00 00       	call   4066 <printf>
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    ...
    192e:	6a 01                	push   $0x1
    1930:	e8 31 27 00 00       	call   4066 <printf>
  ...
  for(i = 0; i < 40; i++){
    ...
    1a17:	6a 01                	push   $0x1
    1a19:	e8 48 26 00 00       	call   4066 <printf>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1ace:	6a 01                	push   $0x1
    1ad0:	e8 91 25 00 00       	call   4066 <printf>
    ...
    1afb:	6a 01                	push   $0x1
    1afd:	e8 64 25 00 00       	call   4066 <printf>
  ...
  if(n != 40){
    ...
    1b51:	6a 01                	push   $0x1
    1b53:	e8 0e 25 00 00       	call   4066 <printf>
  ...
  for(i = 0; i < 40; i++){
    ...
    1b86:	68 bd 44 00 00       	push   $0x44bd
    1b8b:	6a 01                	push   $0x1
    1b8d:	e8 d4 24 00 00       	call   4066 <printf>
  ...
  printf(1, "concreate ok\n");
    ...
    1cc3:	6a 01                	push   $0x1
    1cc5:	e8 9c 23 00 00       	call   4066 <printf>
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    ...
    1cde:	6a 01                	push   $0x1
    1ce0:	e8 81 23 00 00       	call   4066 <printf>
    1ce5:	83 c4 10             	add    $0x10,%esp

  unlink("x");
    1ce8:	83 ec 0c             	sub    $0xc,%esp
    1ceb:	68 f3 48 00 00       	push   $0x48f3
  ...
  if(pid < 0){
    ...
    1d09:	68 bd 44 00 00       	push   $0x44bd
    1d0e:	6a 01                	push   $0x1
    1d10:	e8 51 23 00 00       	call   4066 <printf>
  ...
  for(i = 0; i < 100; i++){
    ...
    1d75:	68 f3 48 00 00       	push   $0x48f3
    ...
    1db0:	68 f3 48 00 00       	push   $0x48f3
    ...
    1dc7:	68 f3 48 00 00       	push   $0x48f3
  ...
  printf(1, "linkunlink ok\n");
    ...
    1dfc:	6a 01                	push   $0x1
    1dfe:	e8 63 22 00 00       	call   4066 <printf>
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    ...
    1e17:	6a 01                	push   $0x1
    1e19:	e8 48 22 00 00       	call   4066 <printf>
  ...
  if(fd < 0){
    ...
    1e57:	6a 01                	push   $0x1
    1e59:	e8 08 22 00 00       	call   4066 <printf>
  ...
  for(i = 0; i < 500; i++){
    ...
    1ecd:	6a 01                	push   $0x1
    1ecf:	e8 92 21 00 00       	call   4066 <printf>
  ...
  for(i = 0; i < 500; i++){
    ...
    1f4d:	6a 01                	push   $0x1
    1f4f:	e8 12 21 00 00       	call   4066 <printf>
  ...
  printf(1, "bigdir ok\n");
    ...
    1f71:	6a 01                	push   $0x1
    1f73:	e8 ee 20 00 00       	call   4066 <printf>
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    ...
    1f8c:	6a 01                	push   $0x1
    1f8e:	e8 d3 20 00 00       	call   4066 <printf>
  ...
  if(mkdir("dd") != 0){
    ...
    1fc2:	6a 01                	push   $0x1
    1fc4:	e8 9d 20 00 00       	call   4066 <printf>
  ...
  if(fd < 0){
    ...
    1ff7:	6a 01                	push   $0x1
    1ff9:	e8 68 20 00 00       	call   4066 <printf>
  ...
  if(unlink("dd") >= 0){
    ...
    2045:	6a 01                	push   $0x1
    2047:	e8 1a 20 00 00       	call   4066 <printf>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    2070:	6a 01                	push   $0x1
    2072:	e8 ef 1f 00 00       	call   4066 <printf>
  ...
  if(fd < 0){
    ...
    20a5:	6a 01                	push   $0x1
    20a7:	e8 ba 1f 00 00       	call   4066 <printf>
  ...
  if(fd < 0){
    ...
    20fa:	6a 01                	push   $0x1
    20fc:	e8 65 1f 00 00       	call   4066 <printf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    213d:	6a 01                	push   $0x1
    213f:	e8 22 1f 00 00       	call   4066 <printf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    217b:	6a 01                	push   $0x1
    217d:	e8 e4 1e 00 00       	call   4066 <printf>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    21a6:	6a 01                	push   $0x1
    21a8:	e8 b9 1e 00 00       	call   4066 <printf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    21d3:	6a 01                	push   $0x1
    21d5:	e8 8c 1e 00 00       	call   4066 <printf>
  ...
  if(chdir("dd") != 0){
    ...
    21fe:	6a 01                	push   $0x1
    2200:	e8 61 1e 00 00       	call   4066 <printf>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    2229:	6a 01                	push   $0x1
    222b:	e8 36 1e 00 00       	call   4066 <printf>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    2254:	6a 01                	push   $0x1
    2256:	e8 0b 1e 00 00       	call   4066 <printf>
  ...
  if(chdir("./..") != 0){
    ...
    227f:	6a 01                	push   $0x1
    2281:	e8 e0 1d 00 00       	call   4066 <printf>
  ...
  if(fd < 0){
    ...
    22b1:	6a 01                	push   $0x1
    22b3:	e8 ae 1d 00 00       	call   4066 <printf>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22e5:	6a 01                	push   $0x1
    22e7:	e8 7a 1d 00 00       	call   4066 <printf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2320:	6a 01                	push   $0x1
    2322:	e8 3f 1d 00 00       	call   4066 <printf>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2350:	6a 01                	push   $0x1
    2352:	e8 0f 1d 00 00       	call   4066 <printf>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2380:	6a 01                	push   $0x1
    2382:	e8 df 1c 00 00       	call   4066 <printf>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    23b0:	6a 01                	push   $0x1
    23b2:	e8 af 1c 00 00       	call   4066 <printf>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    23dd:	6a 01                	push   $0x1
    23df:	e8 82 1c 00 00       	call   4066 <printf>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    240a:	6a 01                	push   $0x1
    240c:	e8 55 1c 00 00       	call   4066 <printf>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    243a:	6a 01                	push   $0x1
    243c:	e8 25 1c 00 00       	call   4066 <printf>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    246a:	6a 01                	push   $0x1
    246c:	e8 f5 1b 00 00       	call   4066 <printf>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    249a:	6a 01                	push   $0x1
    249c:	e8 c5 1b 00 00       	call   4066 <printf>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    24c5:	6a 01                	push   $0x1
    24c7:	e8 9a 1b 00 00       	call   4066 <printf>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    24f0:	6a 01                	push   $0x1
    24f2:	e8 6f 1b 00 00       	call   4066 <printf>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    251b:	6a 01                	push   $0x1
    251d:	e8 44 1b 00 00       	call   4066 <printf>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2546:	6a 01                	push   $0x1
    2548:	e8 19 1b 00 00       	call   4066 <printf>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2571:	6a 01                	push   $0x1
    2573:	e8 ee 1a 00 00       	call   4066 <printf>
  ...
  if(chdir("dd/ff") == 0){
    ...
    259c:	6a 01                	push   $0x1
    259e:	e8 c3 1a 00 00       	call   4066 <printf>
  ...
  if(chdir("dd/xx") == 0){
    ...
    25c7:	6a 01                	push   $0x1
    25c9:	e8 98 1a 00 00       	call   4066 <printf>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    25f2:	6a 01                	push   $0x1
    25f4:	e8 6d 1a 00 00       	call   4066 <printf>
  ...
  if(unlink("dd/ff") != 0){
    ...
    261d:	6a 01                	push   $0x1
    261f:	e8 42 1a 00 00       	call   4066 <printf>
  ...
  if(unlink("dd") == 0){
    ...
    2648:	6a 01                	push   $0x1
    264a:	e8 17 1a 00 00       	call   4066 <printf>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2673:	6a 01                	push   $0x1
    2675:	e8 ec 19 00 00       	call   4066 <printf>
  ...
  if(unlink("dd") < 0){
    ...
    269e:	6a 01                	push   $0x1
    26a0:	e8 c1 19 00 00       	call   4066 <printf>
  ...
  printf(1, "subdir ok\n");
    ...
    26b5:	6a 01                	push   $0x1
    26b7:	e8 aa 19 00 00       	call   4066 <printf>
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    ...
    26d0:	6a 01                	push   $0x1
    26d2:	e8 8f 19 00 00       	call   4066 <printf>
    26d7:	83 c4 10             	add    $0x10,%esp

  unlink("bigwrite");
    26da:	83 ec 0c             	sub    $0xc,%esp
    26dd:	68 53 52 00 00       	push   $0x5253
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    26fe:	68 53 52 00 00       	push   $0x5253
    ...
    2717:	68 5c 52 00 00       	push   $0x525c
    271c:	6a 01                	push   $0x1
    271e:	e8 43 19 00 00       	call   4066 <printf>
    ...
    2760:	6a 01                	push   $0x1
    2762:	e8 ff 18 00 00       	call   4066 <printf>
    ...
    278a:	68 53 52 00 00       	push   $0x5253
  ...
  printf(1, "bigwrite ok\n");
    ...
    27ae:	68 86 52 00 00       	push   $0x5286
    27b3:	6a 01                	push   $0x1
    27b5:	e8 ac 18 00 00       	call   4066 <printf>
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    ...
    27c9:	68 93 52 00 00       	push   $0x5293
    27ce:	6a 01                	push   $0x1
    27d0:	e8 91 18 00 00       	call   4066 <printf>
    27d5:	83 c4 10             	add    $0x10,%esp

  unlink("bigfile");
    27d8:	83 ec 0c             	sub    $0xc,%esp
    27db:	68 a1 52 00 00       	push   $0x52a1
  ...
  fd = open("bigfile", O_CREATE | O_RDWR);
    ...
    27f0:	68 a1 52 00 00       	push   $0x52a1
  ...
  if(fd < 0){
    ...
    2809:	68 a9 52 00 00       	push   $0x52a9
    280e:	6a 01                	push   $0x1
    2810:	e8 51 18 00 00       	call   4066 <printf>
  ...
  for(i = 0; i < 20; i++){
    ...
    2860:	68 bf 52 00 00       	push   $0x52bf
    2865:	6a 01                	push   $0x1
    2867:	e8 fa 17 00 00       	call   4066 <printf>
  ...
  fd = open("bigfile", 0);
    ...
    288f:	6a 00                	push   $0x0
    2891:	68 a1 52 00 00       	push   $0x52a1
  ...
  if(fd < 0){
    ...
    28aa:	68 d5 52 00 00       	push   $0x52d5
    28af:	6a 01                	push   $0x1
    28b1:	e8 b0 17 00 00       	call   4066 <printf>
  ...
  for(i = 0; ; i++){
    ...
    28f0:	68 ea 52 00 00       	push   $0x52ea
    28f5:	6a 01                	push   $0x1
    28f7:	e8 6a 17 00 00       	call   4066 <printf>
    ...
    2916:	68 ff 52 00 00       	push   $0x52ff
    291b:	6a 01                	push   $0x1
    291d:	e8 44 17 00 00       	call   4066 <printf>
    ...
    2961:	68 13 53 00 00       	push   $0x5313
    2966:	6a 01                	push   $0x1
    2968:	e8 f9 16 00 00       	call   4066 <printf>
  ...
  if(total != 20*600){
    ...
    299f:	68 2c 53 00 00       	push   $0x532c
    29a4:	6a 01                	push   $0x1
    29a6:	e8 bb 16 00 00       	call   4066 <printf>
  ...
  unlink("bigfile");
    ...
    29b6:	68 a1 52 00 00       	push   $0x52a1
    29bb:	e8 5f 15 00 00       	call   3f1f <unlink>
    29c0:	83 c4 10             	add    $0x10,%esp

  printf(1, "bigfile test ok\n");
    29c3:	83 ec 08             	sub    $0x8,%esp
    29c6:	68 46 53 00 00       	push   $0x5346
    29cb:	6a 01                	push   $0x1
    29cd:	e8 94 16 00 00       	call   4066 <printf>
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    ...
    29e1:	68 57 53 00 00       	push   $0x5357
    29e6:	6a 01                	push   $0x1
    29e8:	e8 79 16 00 00       	call   4066 <printf>
    29ed:	83 c4 10             	add    $0x10,%esp

  if(mkdir("12345678901234") != 0){
    29f0:	83 ec 0c             	sub    $0xc,%esp
    29f3:	68 66 53 00 00       	push   $0x5366
    ...
    2a07:	68 75 53 00 00       	push   $0x5375
    2a0c:	6a 01                	push   $0x1
    2a0e:	e8 53 16 00 00       	call   4066 <printf>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2a1e:	68 94 53 00 00       	push   $0x5394
    ...
    2a32:	68 b4 53 00 00       	push   $0x53b4
    2a37:	6a 01                	push   $0x1
    2a39:	e8 28 16 00 00       	call   4066 <printf>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2a4e:	68 e4 53 00 00       	push   $0x53e4
  ...
  if(fd < 0){
    ...
    2a67:	68 14 54 00 00       	push   $0x5414
    2a6c:	6a 01                	push   $0x1
    2a6e:	e8 f3 15 00 00       	call   4066 <printf>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2a8c:	6a 00                	push   $0x0
    2a8e:	68 54 54 00 00       	push   $0x5454
  ...
  if(fd < 0){
    ...
    2aa7:	68 84 54 00 00       	push   $0x5484
    2aac:	6a 01                	push   $0x1
    2aae:	e8 b3 15 00 00       	call   4066 <printf>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2acc:	68 be 54 00 00       	push   $0x54be
    ...
    2ae0:	68 dc 54 00 00       	push   $0x54dc
    2ae5:	6a 01                	push   $0x1
    2ae7:	e8 7a 15 00 00       	call   4066 <printf>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2af7:	68 0c 55 00 00       	push   $0x550c
    ...
    2b0b:	68 2c 55 00 00       	push   $0x552c
    2b10:	6a 01                	push   $0x1
    2b12:	e8 4f 15 00 00       	call   4066 <printf>
  ...
  printf(1, "fourteen ok\n");
    ...
    2b22:	68 5d 55 00 00       	push   $0x555d
    2b27:	6a 01                	push   $0x1
    2b29:	e8 38 15 00 00       	call   4066 <printf>
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    ...
    2b3d:	68 6a 55 00 00       	push   $0x556a
    2b42:	6a 01                	push   $0x1
    2b44:	e8 1d 15 00 00       	call   4066 <printf>
    2b49:	83 c4 10             	add    $0x10,%esp
  if(mkdir("dots") != 0){
    2b4c:	83 ec 0c             	sub    $0xc,%esp
    2b4f:	68 76 55 00 00       	push   $0x5576
    ...
    2b63:	68 7b 55 00 00       	push   $0x557b
    2b68:	6a 01                	push   $0x1
    2b6a:	e8 f7 14 00 00       	call   4066 <printf>
  ...
  if(chdir("dots") != 0){
    ...
    2b7a:	68 76 55 00 00       	push   $0x5576
    ...
    2b8e:	68 8e 55 00 00       	push   $0x558e
    2b93:	6a 01                	push   $0x1
    2b95:	e8 cc 14 00 00       	call   4066 <printf>
  ...
  if(unlink(".") == 0){
    ...
    2bb9:	68 a1 55 00 00       	push   $0x55a1
    2bbe:	6a 01                	push   $0x1
    2bc0:	e8 a1 14 00 00       	call   4066 <printf>
  ...
  if(unlink("..") == 0){
    ...
    2bd0:	68 3a 48 00 00       	push   $0x483a
    ...
    2be4:	68 af 55 00 00       	push   $0x55af
    2be9:	6a 01                	push   $0x1
    2beb:	e8 76 14 00 00       	call   4066 <printf>
  ...
  if(chdir("/") != 0){
    ...
    2bfb:	68 8e 44 00 00       	push   $0x448e
    ...
    2c0f:	68 90 44 00 00       	push   $0x4490
    2c14:	6a 01                	push   $0x1
    2c16:	e8 4b 14 00 00       	call   4066 <printf>
  ...
  if(unlink("dots/.") == 0){
    ...
    2c26:	68 be 55 00 00       	push   $0x55be
    ...
    2c3a:	68 c5 55 00 00       	push   $0x55c5
    2c3f:	6a 01                	push   $0x1
    2c41:	e8 20 14 00 00       	call   4066 <printf>
  ...
  if(unlink("dots/..") == 0){
    ...
    2c51:	68 dc 55 00 00       	push   $0x55dc
    ...
    2c65:	68 e4 55 00 00       	push   $0x55e4
    2c6a:	6a 01                	push   $0x1
    2c6c:	e8 f5 13 00 00       	call   4066 <printf>
  ...
  if(unlink("dots") != 0){
    ...
    2c7c:	68 76 55 00 00       	push   $0x5576
    ...
    2c90:	68 fc 55 00 00       	push   $0x55fc
    2c95:	6a 01                	push   $0x1
    2c97:	e8 ca 13 00 00       	call   4066 <printf>
  ...
  printf(1, "rmdot ok\n");
    ...
    2ca7:	68 11 56 00 00       	push   $0x5611
    2cac:	6a 01                	push   $0x1
    2cae:	e8 b3 13 00 00       	call   4066 <printf>
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    ...
    2cc2:	68 1b 56 00 00       	push   $0x561b
    2cc7:	6a 01                	push   $0x1
    2cc9:	e8 98 13 00 00       	call   4066 <printf>
    2cce:	83 c4 10             	add    $0x10,%esp

  fd = open("dirfile", O_CREATE);
    2cd1:	83 ec 08             	sub    $0x8,%esp
    2cd4:	68 00 02 00 00       	push   $0x200
    2cd9:	68 28 56 00 00       	push   $0x5628
  ...
  if(fd < 0){
    ...
    2cf2:	68 30 56 00 00       	push   $0x5630
    2cf7:	6a 01                	push   $0x1
    2cf9:	e8 68 13 00 00       	call   4066 <printf>
  ...
  if(chdir("dirfile") == 0){
    ...
    2d17:	68 28 56 00 00       	push   $0x5628
    ...
    2d2b:	68 47 56 00 00       	push   $0x5647
    2d30:	6a 01                	push   $0x1
    2d32:	e8 2f 13 00 00       	call   4066 <printf>
  ...
  fd = open("dirfile/xx", 0);
    ...
    2d42:	6a 00                	push   $0x0
    2d44:	68 61 56 00 00       	push   $0x5661
  ...
  if(fd >= 0){
    ...
    2d5d:	68 6c 56 00 00       	push   $0x566c
    2d62:	6a 01                	push   $0x1
    2d64:	e8 fd 12 00 00       	call   4066 <printf>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2d79:	68 61 56 00 00       	push   $0x5661
  ...
  if(fd >= 0){
    ...
    2d92:	68 6c 56 00 00       	push   $0x566c
    2d97:	6a 01                	push   $0x1
    2d99:	e8 c8 12 00 00       	call   4066 <printf>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2da9:	68 61 56 00 00       	push   $0x5661
    ...
    2dbd:	68 8a 56 00 00       	push   $0x568a
    2dc2:	6a 01                	push   $0x1
    2dc4:	e8 9d 12 00 00       	call   4066 <printf>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2dd4:	68 61 56 00 00       	push   $0x5661
    ...
    2de8:	68 a7 56 00 00       	push   $0x56a7
    2ded:	6a 01                	push   $0x1
    2def:	e8 72 12 00 00       	call   4066 <printf>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2dff:	68 61 56 00 00       	push   $0x5661
    2e04:	68 c5 56 00 00       	push   $0x56c5
    ...
    2e18:	68 cc 56 00 00       	push   $0x56cc
    2e1d:	6a 01                	push   $0x1
    2e1f:	e8 42 12 00 00       	call   4066 <printf>
  ...
  if(unlink("dirfile") != 0){
    ...
    2e2f:	68 28 56 00 00       	push   $0x5628
    ...
    2e43:	68 eb 56 00 00       	push   $0x56eb
    2e48:	6a 01                	push   $0x1
    2e4a:	e8 17 12 00 00       	call   4066 <printf>
  ...
  if(fd >= 0){
    ...
    2e75:	68 04 57 00 00       	push   $0x5704
    2e7a:	6a 01                	push   $0x1
    2e7c:	e8 e5 11 00 00       	call   4066 <printf>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2ea1:	6a 01                	push   $0x1
    2ea3:	68 f3 48 00 00       	push   $0x48f3
    ...
    2eba:	68 23 57 00 00       	push   $0x5723
    2ebf:	6a 01                	push   $0x1
    2ec1:	e8 a0 11 00 00       	call   4066 <printf>
  ...
  printf(1, "dir vs file OK\n");
    ...
    2edf:	68 37 57 00 00       	push   $0x5737
    2ee4:	6a 01                	push   $0x1
    2ee6:	e8 7b 11 00 00       	call   4066 <printf>
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    ...
    2efa:	68 47 57 00 00       	push   $0x5747
    2eff:	6a 01                	push   $0x1
    2f01:	e8 60 11 00 00       	call   4066 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2f18:	68 58 57 00 00       	push   $0x5758
    ...
    2f2c:	68 5e 57 00 00       	push   $0x575e
    2f31:	6a 01                	push   $0x1
    2f33:	e8 2e 11 00 00       	call   4066 <printf>
    ...
    2f43:	68 58 57 00 00       	push   $0x5758
    ...
    2f57:	68 72 57 00 00       	push   $0x5772
    2f5c:	6a 01                	push   $0x1
    2f5e:	e8 03 11 00 00       	call   4066 <printf>
    ...
    2fc4:	68 87 57 00 00       	push   $0x5787
    ...
    2feb:	68 87 57 00 00       	push   $0x5787
  ...
  chdir("/");
    ...
    3009:	68 8e 44 00 00       	push   $0x448e
    300e:	e8 2c 0f 00 00       	call   3f3f <chdir>
    3013:	83 c4 10             	add    $0x10,%esp
  printf(1, "empty file name OK\n");
    3016:	83 ec 08             	sub    $0x8,%esp
    3019:	68 8a 57 00 00       	push   $0x578a
    301e:	6a 01                	push   $0x1
    3020:	e8 41 10 00 00       	call   4066 <printf>
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    ...
    3034:	68 9e 57 00 00       	push   $0x579e
    3039:	6a 01                	push   $0x1
    303b:	e8 26 10 00 00       	call   4066 <printf>
    ...
    3060:	e8 6a 0e 00 00       	call   3ecf <exit>
{
  ...
  if(n == 1000){
    ...
    3081:	68 ac 57 00 00       	push   $0x57ac
    3086:	6a 01                	push   $0x1
    3088:	e8 d9 0f 00 00       	call   4066 <printf>
  ...
  for(; n > 0; n--){
    ...
    30a1:	68 ce 57 00 00       	push   $0x57ce
    30a6:	6a 01                	push   $0x1
    30a8:	e8 b9 0f 00 00       	call   4066 <printf>
  ...
  if(wait() != -1){
    ...
    30cc:	68 e2 57 00 00       	push   $0x57e2
    30d1:	6a 01                	push   $0x1
    30d3:	e8 8e 0f 00 00       	call   4066 <printf>
  ...
  printf(1, "fork test OK\n");
    ...
    30e3:	68 f5 57 00 00       	push   $0x57f5
    30e8:	6a 01                	push   $0x1
    30ea:	e8 77 0f 00 00       	call   4066 <printf>
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    30fc:	a1 d8 62 00 00       	mov    0x62d8,%eax
    3101:	83 ec 08             	sub    $0x8,%esp
    3104:	68 03 58 00 00       	push   $0x5803
    3109:	50                   	push   %eax
    310a:	e8 57 0f 00 00       	call   4066 <printf>
  ...
  if(pid < 0){
    ...
    31a1:	a1 d8 62 00 00       	mov    0x62d8,%eax
    31a6:	83 ec 08             	sub    $0x8,%esp
    31a9:	68 29 58 00 00       	push   $0x5829
    31ae:	50                   	push   %eax
    31af:	e8 b2 0e 00 00       	call   4066 <printf>
  ...
  if(c != a + 1){
    ...
    31e7:	a1 d8 62 00 00       	mov    0x62d8,%eax
    31ec:	83 ec 08             	sub    $0x8,%esp
    31ef:	68 40 58 00 00       	push   $0x5840
    31f4:	50                   	push   %eax
    31f5:	e8 6c 0e 00 00       	call   4066 <printf>
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    324b:	a1 d8 62 00 00       	mov    0x62d8,%eax
    3250:	83 ec 08             	sub    $0x8,%esp
    3253:	68 5c 58 00 00       	push   $0x585c
    3258:	50                   	push   %eax
    3259:	e8 08 0e 00 00       	call   4066 <printf>
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    329c:	a1 d8 62 00 00       	mov    0x62d8,%eax
    32a1:	83 ec 08             	sub    $0x8,%esp
    32a4:	68 9a 58 00 00       	push   $0x589a
    32a9:	50                   	push   %eax
    32aa:	e8 b7 0d 00 00       	call   4066 <printf>
  ...
  if(c != a - 4096){
    ...
    32d4:	a1 d8 62 00 00       	mov    0x62d8,%eax
    32d9:	ff 75 e0             	pushl  -0x20(%ebp)
    32dc:	ff 75 f4             	pushl  -0xc(%ebp)
    32df:	68 b8 58 00 00       	push   $0x58b8
    32e4:	50                   	push   %eax
    32e5:	e8 7c 0d 00 00       	call   4066 <printf>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3338:	a1 d8 62 00 00       	mov    0x62d8,%eax
    333d:	ff 75 e0             	pushl  -0x20(%ebp)
    3340:	ff 75 f4             	pushl  -0xc(%ebp)
    3343:	68 f0 58 00 00       	push   $0x58f0
    3348:	50                   	push   %eax
    3349:	e8 18 0d 00 00       	call   4066 <printf>
  ...
  if(*lastaddr == 99){
    ...
    3360:	a1 d8 62 00 00       	mov    0x62d8,%eax
    3365:	83 ec 08             	sub    $0x8,%esp
    3368:	68 18 59 00 00       	push   $0x5918
    336d:	50                   	push   %eax
    336e:	e8 f3 0c 00 00       	call   4066 <printf>
  ...
  if(c != a){
    ...
    33b6:	a1 d8 62 00 00       	mov    0x62d8,%eax
    33bb:	ff 75 e0             	pushl  -0x20(%ebp)
    33be:	ff 75 f4             	pushl  -0xc(%ebp)
    33c1:	68 48 59 00 00       	push   $0x5948
    33c6:	50                   	push   %eax
    33c7:	e8 9a 0c 00 00       	call   4066 <printf>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    33f1:	79 1b                	jns    340e <sbrktest+0x319>
      printf(stdout, "fork failed\n");
    33f3:	a1 d8 62 00 00       	mov    0x62d8,%eax
    33f8:	83 ec 08             	sub    $0x8,%esp
    33fb:	68 bd 44 00 00       	push   $0x44bd
    3400:	50                   	push   %eax
    3401:	e8 60 0c 00 00       	call   4066 <printf>
    ...
    341d:	a1 d8 62 00 00       	mov    0x62d8,%eax
    3422:	52                   	push   %edx
    3423:	ff 75 f4             	pushl  -0xc(%ebp)
    3426:	68 69 59 00 00       	push   $0x5969
    342b:	50                   	push   %eax
    342c:	e8 35 0c 00 00       	call   4066 <printf>
  ...
  if(pipe(fds) != 0){
    ...
    3472:	68 8e 48 00 00       	push   $0x488e
    3477:	6a 01                	push   $0x1
    3479:	e8 e8 0b 00 00       	call   4066 <printf>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    34d3:	6a 01                	push   $0x1
    34d5:	68 f3 48 00 00       	push   $0x48f3
    34da:	50                   	push   %eax
  ...
  if(c == (char*)0xffffffff){
    ...
    357b:	a1 d8 62 00 00       	mov    0x62d8,%eax
    3580:	83 ec 08             	sub    $0x8,%esp
    3583:	68 82 59 00 00       	push   $0x5982
    3588:	50                   	push   %eax
    3589:	e8 d8 0a 00 00       	call   4066 <printf>
  ...
  printf(stdout, "sbrk test OK\n");
    35c8:	a1 d8 62 00 00       	mov    0x62d8,%eax
    35cd:	83 ec 08             	sub    $0x8,%esp
    35d0:	68 9d 59 00 00       	push   $0x599d
    35d5:	50                   	push   %eax
    35d6:	e8 8b 0a 00 00       	call   4066 <printf>
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    360d:	a1 d8 62 00 00       	mov    0x62d8,%eax
    3612:	83 ec 08             	sub    $0x8,%esp
    3615:	68 ab 59 00 00       	push   $0x59ab
    361a:	50                   	push   %eax
    361b:	e8 46 0a 00 00       	call   4066 <printf>
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    368b:	50                   	push   %eax
    368c:	68 ba 59 00 00       	push   $0x59ba
    ...
    369e:	a1 d8 62 00 00       	mov    0x62d8,%eax
    36a3:	83 ec 08             	sub    $0x8,%esp
    36a6:	68 c5 59 00 00       	push   $0x59c5
    36ab:	50                   	push   %eax
    36ac:	e8 b5 09 00 00       	call   4066 <printf>
  ...
  printf(stdout, "validate ok\n");
    36cc:	a1 d8 62 00 00       	mov    0x62d8,%eax
    36d1:	83 ec 08             	sub    $0x8,%esp
    36d4:	68 de 59 00 00       	push   $0x59de
    36d9:	50                   	push   %eax
    36da:	e8 87 09 00 00       	call   4066 <printf>
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    36eb:	a1 d8 62 00 00       	mov    0x62d8,%eax
    36f0:	83 ec 08             	sub    $0x8,%esp
    36f3:	68 eb 59 00 00       	push   $0x59eb
    36f8:	50                   	push   %eax
    36f9:	e8 68 09 00 00       	call   4066 <printf>
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    3719:	a1 d8 62 00 00       	mov    0x62d8,%eax
    371e:	83 ec 08             	sub    $0x8,%esp
    3721:	68 f5 59 00 00       	push   $0x59f5
    3726:	50                   	push   %eax
    3727:	e8 3a 09 00 00       	call   4066 <printf>
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    3742:	a1 d8 62 00 00       	mov    0x62d8,%eax
    3747:	83 ec 08             	sub    $0x8,%esp
    374a:	68 06 5a 00 00       	push   $0x5a06
    374f:	50                   	push   %eax
    3750:	e8 11 09 00 00       	call   4066 <printf>
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    ...
    3764:	68 13 5a 00 00       	push   $0x5a13
  ...
  if(pid == 0){
    ...
    378f:	c7 04 85 00 63 00 00 	movl   $0x5a20,0x6300(,%eax,4)
    3796:	20 5a 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    3820:	a1 d8 62 00 00       	mov    0x62d8,%eax
    3825:	83 ec 08             	sub    $0x8,%esp
    3828:	68 1a 5b 00 00       	push   $0x5b1a
    382d:	50                   	push   %eax
    382e:	e8 33 08 00 00       	call   4066 <printf>
  ...
  fd = open("bigarg-ok", 0);
    ...
    3843:	6a 00                	push   $0x0
    3845:	68 13 5a 00 00       	push   $0x5a13
  ...
  if(fd < 0){
    ...
    385b:	a1 d8 62 00 00       	mov    0x62d8,%eax
    3860:	83 ec 08             	sub    $0x8,%esp
    3863:	68 33 5b 00 00       	push   $0x5b33
    3868:	50                   	push   %eax
    3869:	e8 f8 07 00 00       	call   4066 <printf>
  ...
  unlink("bigarg-ok");
    ...
    3887:	68 13 5a 00 00       	push   $0x5a13
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    ...
    38a8:	68 48 5b 00 00       	push   $0x5b48
    38ad:	6a 01                	push   $0x1
    38af:	e8 b2 07 00 00       	call   4066 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    398c:	50                   	push   %eax
    398d:	68 55 5b 00 00       	push   $0x5b55
    3992:	6a 01                	push   $0x1
    3994:	e8 cd 06 00 00       	call   4066 <printf>
    ...
    39bf:	50                   	push   %eax
    39c0:	68 61 5b 00 00       	push   $0x5b61
    39c5:	6a 01                	push   $0x1
    39c7:	e8 9a 06 00 00       	call   4066 <printf>
    ...
    3a0f:	68 71 5b 00 00       	push   $0x5b71
    3a14:	6a 01                	push   $0x1
    3a16:	e8 4b 06 00 00       	call   4066 <printf>
  ...
  printf(1, "fsfull test finished\n");
    ...
    3b29:	68 81 5b 00 00       	push   $0x5b81
    3b2e:	6a 01                	push   $0x1
    3b30:	e8 31 05 00 00       	call   4066 <printf>
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3b41:	a1 dc 62 00 00       	mov    0x62dc,%eax
    3b46:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    3b4c:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3b51:	a3 dc 62 00 00       	mov    %eax,0x62dc
  return randstate;
    3b56:	a1 dc 62 00 00       	mov    0x62dc,%eax
}
    3b5b:	5d                   	pop    %ebp
    3b5c:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    ...
    3b71:	68 97 5b 00 00       	push   $0x5b97
    3b76:	6a 01                	push   $0x1
    3b78:	e8 e9 04 00 00       	call   4066 <printf>
    3b7d:	83 c4 10             	add    $0x10,%esp

  if(open("usertests.ran", 0) >= 0){
    3b80:	83 ec 08             	sub    $0x8,%esp
    3b83:	6a 00                	push   $0x0
    3b85:	68 ab 5b 00 00       	push   $0x5bab
    ...
    3b99:	68 bc 5b 00 00       	push   $0x5bbc
    3b9e:	6a 01                	push   $0x1
    3ba0:	e8 c1 04 00 00       	call   4066 <printf>
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3bb5:	68 ab 5b 00 00       	push   $0x5bab
...
00003f77 <up>:
SYSCALL(up)
    3f77:	b8 18 00 00 00       	mov    $0x18,%eax
    3f7c:	cd 40                	int    $0x40
    3f7e:	c3                   	ret    

00003f7f <down>:
SYSCALL(down)
    3f7f:	b8 17 00 00 00       	mov    $0x17,%eax
    3f84:	cd 40                	int    $0x40
    3f86:	c3                   	ret    
...
putc(int fd, char c)
{
    ...
    3f92:	83 ec 18             	sub    $0x18,%esp
    3f95:	8b 45 0c             	mov    0xc(%ebp),%eax
    3f98:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    3f9b:	83 ec 04             	sub    $0x4,%esp
    3f9e:	6a 01                	push   $0x1
    3fa0:	8d 45 f4             	lea    -0xc(%ebp),%eax
    3fa3:	50                   	push   %eax
    3fa4:	ff 75 08             	pushl  0x8(%ebp)
    3fa7:	e8 43 ff ff ff       	call   3eef <write>
    3fac:	83 c4 10             	add    $0x10,%esp
}
    3faf:	90                   	nop
    3fb0:	c9                   	leave  
    3fb1:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    3fb9:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    3fc0:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    3fc4:	74 17                	je     3fdd <printint+0x2b>
    3fc6:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    3fca:	79 11                	jns    3fdd <printint+0x2b>
    neg = 1;
    3fcc:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    3fd3:	8b 45 0c             	mov    0xc(%ebp),%eax
    3fd6:	f7 d8                	neg    %eax
    3fd8:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3fdb:	eb 06                	jmp    3fe3 <printint+0x31>
  } else {
    x = xx;
    3fdd:	8b 45 0c             	mov    0xc(%ebp),%eax
    3fe0:	89 45 ec             	mov    %eax,-0x14(%ebp)
  }

  i = 0;
    3fe3:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    3fea:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    3fed:	8d 41 01             	lea    0x1(%ecx),%eax
    3ff0:	89 45 f4             	mov    %eax,-0xc(%ebp)
    3ff3:	8b 5d 10             	mov    0x10(%ebp),%ebx
    3ff6:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3ff9:	ba 00 00 00 00       	mov    $0x0,%edx
    3ffe:	f7 f3                	div    %ebx
    4000:	89 d0                	mov    %edx,%eax
    4002:	0f b6 80 e0 62 00 00 	movzbl 0x62e0(%eax),%eax
    4009:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    400d:	8b 5d 10             	mov    0x10(%ebp),%ebx
    4010:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4013:	ba 00 00 00 00       	mov    $0x0,%edx
    4018:	f7 f3                	div    %ebx
    401a:	89 45 ec             	mov    %eax,-0x14(%ebp)
    401d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4021:	75 c7                	jne    3fea <printint+0x38>
  if(neg)
    4023:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4027:	74 2d                	je     4056 <printint+0xa4>
    buf[i++] = '-';
    4029:	8b 45 f4             	mov    -0xc(%ebp),%eax
    402c:	8d 50 01             	lea    0x1(%eax),%edx
    402f:	89 55 f4             	mov    %edx,-0xc(%ebp)
    4032:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    4037:	eb 1d                	jmp    4056 <printint+0xa4>
    putc(fd, buf[i]);
    4039:	8d 55 dc             	lea    -0x24(%ebp),%edx
    403c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    403f:	01 d0                	add    %edx,%eax
    4041:	0f b6 00             	movzbl (%eax),%eax
    4044:	0f be c0             	movsbl %al,%eax
    4047:	83 ec 08             	sub    $0x8,%esp
    404a:	50                   	push   %eax
    404b:	ff 75 08             	pushl  0x8(%ebp)
    404e:	e8 3c ff ff ff       	call   3f8f <putc>
  ...
  while(--i >= 0)
    4056:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    405a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    405e:	79 d9                	jns    4039 <printint+0x87>
    putc(fd, buf[i]);
}
    4060:	90                   	nop
    4061:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    4064:	c9                   	leave  
    4065:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
    ...
    4069:	83 ec 28             	sub    $0x28,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    406c:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    4073:	8d 45 0c             	lea    0xc(%ebp),%eax
    4076:	83 c0 04             	add    $0x4,%eax
    4079:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    407c:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    4083:	e9 59 01 00 00       	jmp    41e1 <printf+0x17b>
    c = fmt[i] & 0xff;
    4088:	8b 55 0c             	mov    0xc(%ebp),%edx
    408b:	8b 45 f0             	mov    -0x10(%ebp),%eax
    408e:	01 d0                	add    %edx,%eax
    4090:	0f b6 00             	movzbl (%eax),%eax
    4093:	0f be c0             	movsbl %al,%eax
    4096:	25 ff 00 00 00       	and    $0xff,%eax
    409b:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    409e:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    40a2:	75 2c                	jne    40d0 <printf+0x6a>
      if(c == '%'){
    40a4:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    40a8:	75 0c                	jne    40b6 <printf+0x50>
        state = '%';
    40aa:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    40b1:	e9 27 01 00 00       	jmp    41dd <printf+0x177>
      } else {
        putc(fd, c);
    40b6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    40b9:	0f be c0             	movsbl %al,%eax
    40bc:	83 ec 08             	sub    $0x8,%esp
    40bf:	50                   	push   %eax
    40c0:	ff 75 08             	pushl  0x8(%ebp)
    40c3:	e8 c7 fe ff ff       	call   3f8f <putc>
    40c8:	83 c4 10             	add    $0x10,%esp
    40cb:	e9 0d 01 00 00       	jmp    41dd <printf+0x177>
      }
    } else if(state == '%'){
    40d0:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    40d4:	0f 85 03 01 00 00    	jne    41dd <printf+0x177>
      if(c == 'd'){
    40da:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    40de:	75 1e                	jne    40fe <printf+0x98>
        printint(fd, *ap, 10, 1);
    40e0:	8b 45 e8             	mov    -0x18(%ebp),%eax
    40e3:	8b 00                	mov    (%eax),%eax
    40e5:	6a 01                	push   $0x1
    40e7:	6a 0a                	push   $0xa
    40e9:	50                   	push   %eax
    40ea:	ff 75 08             	pushl  0x8(%ebp)
    40ed:	e8 c0 fe ff ff       	call   3fb2 <printint>
    40f2:	83 c4 10             	add    $0x10,%esp
        ap++;
    40f5:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    40f9:	e9 d8 00 00 00       	jmp    41d6 <printf+0x170>
      } else if(c == 'x' || c == 'p'){
    40fe:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    4102:	74 06                	je     410a <printf+0xa4>
    4104:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    4108:	75 1e                	jne    4128 <printf+0xc2>
        printint(fd, *ap, 16, 0);
    410a:	8b 45 e8             	mov    -0x18(%ebp),%eax
    410d:	8b 00                	mov    (%eax),%eax
    410f:	6a 00                	push   $0x0
    4111:	6a 10                	push   $0x10
    4113:	50                   	push   %eax
    4114:	ff 75 08             	pushl  0x8(%ebp)
    4117:	e8 96 fe ff ff       	call   3fb2 <printint>
    411c:	83 c4 10             	add    $0x10,%esp
        ap++;
    411f:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4123:	e9 ae 00 00 00       	jmp    41d6 <printf+0x170>
      } else if(c == 's'){
    4128:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    412c:	75 43                	jne    4171 <printf+0x10b>
        s = (char*)*ap;
    ...
    413e:	75 25                	jne    4165 <printf+0xff>
          s = "(null)";
    4140:	c7 45 f4 e6 5b 00 00 	movl   $0x5be6,-0xc(%ebp)
        while(*s != 0){
    4147:	eb 1c                	jmp    4165 <printf+0xff>
          putc(fd, *s);
    ...
    4155:	50                   	push   %eax
    4156:	ff 75 08             	pushl  0x8(%ebp)
    4159:	e8 31 fe ff ff       	call   3f8f <putc>
    415e:	83 c4 10             	add    $0x10,%esp
          s++;
    4161:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    4165:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4168:	0f b6 00             	movzbl (%eax),%eax
    416b:	84 c0                	test   %al,%al
    416d:	75 da                	jne    4149 <printf+0xe3>
    416f:	eb 65                	jmp    41d6 <printf+0x170>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    4171:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    4175:	75 1d                	jne    4194 <printf+0x12e>
        putc(fd, *ap);
    4177:	8b 45 e8             	mov    -0x18(%ebp),%eax
    417a:	8b 00                	mov    (%eax),%eax
    417c:	0f be c0             	movsbl %al,%eax
    417f:	83 ec 08             	sub    $0x8,%esp
    4182:	50                   	push   %eax
    4183:	ff 75 08             	pushl  0x8(%ebp)
    4186:	e8 04 fe ff ff       	call   3f8f <putc>
    418b:	83 c4 10             	add    $0x10,%esp
        ap++;
    418e:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4192:	eb 42                	jmp    41d6 <printf+0x170>
      } else if(c == '%'){
    4194:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    4198:	75 17                	jne    41b1 <printf+0x14b>
        putc(fd, c);
    419a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    419d:	0f be c0             	movsbl %al,%eax
    41a0:	83 ec 08             	sub    $0x8,%esp
    41a3:	50                   	push   %eax
    41a4:	ff 75 08             	pushl  0x8(%ebp)
    41a7:	e8 e3 fd ff ff       	call   3f8f <putc>
    41ac:	83 c4 10             	add    $0x10,%esp
    41af:	eb 25                	jmp    41d6 <printf+0x170>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    41b1:	83 ec 08             	sub    $0x8,%esp
    41b4:	6a 25                	push   $0x25
    41b6:	ff 75 08             	pushl  0x8(%ebp)
    41b9:	e8 d1 fd ff ff       	call   3f8f <putc>
    41be:	83 c4 10             	add    $0x10,%esp
        putc(fd, c);
    41c1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    41c4:	0f be c0             	movsbl %al,%eax
    41c7:	83 ec 08             	sub    $0x8,%esp
    41ca:	50                   	push   %eax
    41cb:	ff 75 08             	pushl  0x8(%ebp)
    41ce:	e8 bc fd ff ff       	call   3f8f <putc>
    41d3:	83 c4 10             	add    $0x10,%esp
      }
      state = 0;
    41d6:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    41dd:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    41e1:	8b 55 0c             	mov    0xc(%ebp),%edx
    41e4:	8b 45 f0             	mov    -0x10(%ebp),%eax
    41e7:	01 d0                	add    %edx,%eax
    41e9:	0f b6 00             	movzbl (%eax),%eax
    41ec:	84 c0                	test   %al,%al
    41ee:	0f 85 94 fe ff ff    	jne    4088 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
    ...
    41fa:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    41fd:	8b 45 08             	mov    0x8(%ebp),%eax
    4200:	83 e8 08             	sub    $0x8,%eax
    4203:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4206:	a1 88 63 00 00       	mov    0x6388,%eax
    420b:	89 45 fc             	mov    %eax,-0x4(%ebp)
    420e:	eb 24                	jmp    4234 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4210:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4213:	8b 00                	mov    (%eax),%eax
    4215:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    4218:	77 12                	ja     422c <free+0x35>
    421a:	8b 45 f8             	mov    -0x8(%ebp),%eax
    421d:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    4220:	77 24                	ja     4246 <free+0x4f>
    4222:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4225:	8b 00                	mov    (%eax),%eax
    4227:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    422a:	77 1a                	ja     4246 <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    4237:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    423a:	76 d4                	jbe    4210 <free+0x19>
    423c:	8b 45 fc             	mov    -0x4(%ebp),%eax
    423f:	8b 00                	mov    (%eax),%eax
    4241:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4244:	76 ca                	jbe    4210 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    4246:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4249:	8b 40 04             	mov    0x4(%eax),%eax
    424c:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    4253:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4256:	01 c2                	add    %eax,%edx
    4258:	8b 45 fc             	mov    -0x4(%ebp),%eax
    425b:	8b 00                	mov    (%eax),%eax
    425d:	39 c2                	cmp    %eax,%edx
    425f:	75 24                	jne    4285 <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
    4261:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4264:	8b 50 04             	mov    0x4(%eax),%edx
    4267:	8b 45 fc             	mov    -0x4(%ebp),%eax
    426a:	8b 00                	mov    (%eax),%eax
    426c:	8b 40 04             	mov    0x4(%eax),%eax
    426f:	01 c2                	add    %eax,%edx
    4271:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4274:	89 50 04             	mov    %edx,0x4(%eax)
    bp->s.ptr = p->s.ptr->s.ptr;
    4277:	8b 45 fc             	mov    -0x4(%ebp),%eax
    427a:	8b 00                	mov    (%eax),%eax
    427c:	8b 10                	mov    (%eax),%edx
    427e:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4281:	89 10                	mov    %edx,(%eax)
    4283:	eb 0a                	jmp    428f <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
    4285:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4288:	8b 10                	mov    (%eax),%edx
    428a:	8b 45 f8             	mov    -0x8(%ebp),%eax
    428d:	89 10                	mov    %edx,(%eax)
  if(p + p->s.size == bp){
    428f:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4292:	8b 40 04             	mov    0x4(%eax),%eax
    4295:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    429c:	8b 45 fc             	mov    -0x4(%ebp),%eax
    429f:	01 d0                	add    %edx,%eax
    42a1:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    42a4:	75 20                	jne    42c6 <free+0xcf>
    p->s.size += bp->s.size;
    42a6:	8b 45 fc             	mov    -0x4(%ebp),%eax
    42a9:	8b 50 04             	mov    0x4(%eax),%edx
    42ac:	8b 45 f8             	mov    -0x8(%ebp),%eax
    42af:	8b 40 04             	mov    0x4(%eax),%eax
    42b2:	01 c2                	add    %eax,%edx
    ...
    42c4:	eb 08                	jmp    42ce <free+0xd7>
  } else
    p->s.ptr = bp;
    42c6:	8b 45 fc             	mov    -0x4(%ebp),%eax
    42c9:	8b 55 f8             	mov    -0x8(%ebp),%edx
    42cc:	89 10                	mov    %edx,(%eax)
  freep = p;
    42ce:	8b 45 fc             	mov    -0x4(%ebp),%eax
    42d1:	a3 88 63 00 00       	mov    %eax,0x6388
}
    42d6:	90                   	nop
    42d7:	c9                   	leave  
    42d8:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    42f5:	83 ec 0c             	sub    $0xc,%esp
    42f8:	50                   	push   %eax
    42f9:	e8 59 fc ff ff       	call   3f57 <sbrk>
    42fe:	83 c4 10             	add    $0x10,%esp
    4301:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    4304:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    4308:	75 07                	jne    4311 <morecore+0x38>
    return 0;
    430a:	b8 00 00 00 00       	mov    $0x0,%eax
    430f:	eb 26                	jmp    4337 <morecore+0x5e>
  hp = (Header*)p;
  ...
  free((void*)(hp + 1));
    ...
    4326:	83 ec 0c             	sub    $0xc,%esp
    4329:	50                   	push   %eax
    432a:	e8 c8 fe ff ff       	call   41f7 <free>
    432f:	83 c4 10             	add    $0x10,%esp
  return freep;
    4332:	a1 88 63 00 00       	mov    0x6388,%eax
}
    4337:	c9                   	leave  
    4338:	c3                   	ret    
...
malloc(uint nbytes)
{
    ...
    433c:	83 ec 18             	sub    $0x18,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    433f:	8b 45 08             	mov    0x8(%ebp),%eax
    4342:	83 c0 07             	add    $0x7,%eax
    4345:	c1 e8 03             	shr    $0x3,%eax
    4348:	83 c0 01             	add    $0x1,%eax
    434b:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    434e:	a1 88 63 00 00       	mov    0x6388,%eax
    4353:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4356:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    435a:	75 23                	jne    437f <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    435c:	c7 45 f0 80 63 00 00 	movl   $0x6380,-0x10(%ebp)
    4363:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4366:	a3 88 63 00 00       	mov    %eax,0x6388
    436b:	a1 88 63 00 00       	mov    0x6388,%eax
    4370:	a3 80 63 00 00       	mov    %eax,0x6380
    base.s.size = 0;
    4375:	c7 05 84 63 00 00 00 	movl   $0x0,0x6384
    437c:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    437f:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4382:	8b 00                	mov    (%eax),%eax
    4384:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    4387:	8b 45 f4             	mov    -0xc(%ebp),%eax
    438a:	8b 40 04             	mov    0x4(%eax),%eax
    438d:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    4390:	72 4d                	jb     43df <malloc+0xa6>
      if(p->s.size == nunits)
    4392:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4395:	8b 40 04             	mov    0x4(%eax),%eax
    4398:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    439b:	75 0c                	jne    43a9 <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    439d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43a0:	8b 10                	mov    (%eax),%edx
    43a2:	8b 45 f0             	mov    -0x10(%ebp),%eax
    43a5:	89 10                	mov    %edx,(%eax)
    43a7:	eb 26                	jmp    43cf <malloc+0x96>
      else {
        p->s.size -= nunits;
    43a9:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43ac:	8b 40 04             	mov    0x4(%eax),%eax
    43af:	2b 45 ec             	sub    -0x14(%ebp),%eax
    43b2:	89 c2                	mov    %eax,%edx
    43b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43b7:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    43ba:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43bd:	8b 40 04             	mov    0x4(%eax),%eax
    43c0:	c1 e0 03             	shl    $0x3,%eax
    43c3:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    43c6:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43c9:	8b 55 ec             	mov    -0x14(%ebp),%edx
    43cc:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    43cf:	8b 45 f0             	mov    -0x10(%ebp),%eax
    43d2:	a3 88 63 00 00       	mov    %eax,0x6388
      return (void*)(p + 1);
    43d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
    43da:	83 c0 08             	add    $0x8,%eax
    43dd:	eb 3b                	jmp    441a <malloc+0xe1>
    }
    if(p == freep)
    43df:	a1 88 63 00 00       	mov    0x6388,%eax
    43e4:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    43e7:	75 1e                	jne    4407 <malloc+0xce>
      if((p = morecore(nunits)) == 0)
    43e9:	83 ec 0c             	sub    $0xc,%esp
    43ec:	ff 75 ec             	pushl  -0x14(%ebp)
    43ef:	e8 e5 fe ff ff       	call   42d9 <morecore>
    43f4:	83 c4 10             	add    $0x10,%esp
    43f7:	89 45 f4             	mov    %eax,-0xc(%ebp)
    43fa:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    43fe:	75 07                	jne    4407 <malloc+0xce>
        return 0;
    4400:	b8 00 00 00 00       	mov    $0x0,%eax
    4405:	eb 13                	jmp    441a <malloc+0xe1>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4407:	8b 45 f4             	mov    -0xc(%ebp),%eax
    440a:	89 45 f0             	mov    %eax,-0x10(%ebp)
    ...
    4415:	e9 6d ff ff ff       	jmp    4387 <malloc+0x4e>
}
    441a:	c9                   	leave  
    441b:	c3                   	ret    
