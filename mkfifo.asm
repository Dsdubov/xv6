...
_mkfifo:     формат файла elf32-i386
...
main(int argc, char *argv[])
{
  ...
  4d:	50                   	push   %eax
  4e:	e8 34 03 00 00       	call   387 <mkfifo>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41a:	0f b6 80 bc 0a 00 00 	movzbl 0xabc(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 556:	75 25                	jne    57d <printf+0xff>
          s = "(null)";
 558:	c7 45 f4 69 08 00 00 	movl   $0x869,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 61e:	a1 d8 0a 00 00       	mov    0xad8,%eax
...
free(void *ap)
{
 ...
 6e9:	a3 d8 0a 00 00       	mov    %eax,0xad8
}
 6ee:	90                   	nop
 6ef:	c9                   	leave  
 6f0:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 747:	83 c4 10             	add    $0x10,%esp
  return freep;
 74a:	a1 d8 0a 00 00       	mov    0xad8,%eax
}
 74f:	c9                   	leave  
 750:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7ea:	a3 d8 0a 00 00       	mov    %eax,0xad8
      return (void*)(p + 1);
 ...
 7f5:	eb 3b                	jmp    832 <malloc+0xe1>
    ...
    if(p == freep)
 7f7:	a1 d8 0a 00 00       	mov    0xad8,%eax
