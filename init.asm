...
main(void)
{
  ...
  a2:	75 3e                	jne    e2 <main+0xe2>
      exec("login", argv); // was "sh", now sh execs from login.c
  a4:	83 ec 08             	sub    $0x8,%esp
  a7:	68 4c 0b 00 00       	push   $0xb4c
  ac:	68 d6 08 00 00       	push   $0x8d6
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48b:	0f b6 80 54 0b 00 00 	movzbl 0xb54(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 5c7:	75 25                	jne    5ee <printf+0xff>
          s = "(null)";
 5c9:	c7 45 f4 fb 08 00 00 	movl   $0x8fb,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 68f:	a1 70 0b 00 00       	mov    0xb70,%eax
...
morecore(uint nu)
{
 ...
 7b8:	83 c4 10             	add    $0x10,%esp
  return freep;
 7bb:	a1 70 0b 00 00       	mov    0xb70,%eax
}
 7c0:	c9                   	leave  
 7c1:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7e5:	c7 45 f0 68 0b 00 00 	movl   $0xb68,-0x10(%ebp)
 7ec:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7ef:	a3 70 0b 00 00       	mov    %eax,0xb70
 7f4:	a1 70 0b 00 00       	mov    0xb70,%eax
 7f9:	a3 68 0b 00 00       	mov    %eax,0xb68
    base.s.size = 0;
 7fe:	c7 05 6c 0b 00 00 00 	movl   $0x0,0xb6c
 805:	00 00 00 
  }
 ...
 85b:	a3 70 0b 00 00       	mov    %eax,0xb70
      return (void*)(p + 1);
 ...
 866:	eb 3b                	jmp    8a3 <malloc+0xe1>
    ...
    if(p == freep)
 868:	a1 70 0b 00 00       	mov    0xb70,%eax
